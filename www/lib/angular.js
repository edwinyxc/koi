...
/**
 * when using forEach the properties are value, key, but it is often useful to have key, value.
...
LocationUrl.prototype = {
   ...
   *
   * @param {string|object<string,string>=} search New search properties - string or hash object
     ...
     <example module="ngView">
       <file name="index.html">
         <div ng-controller="MainCntl">
           ...
           <pre>$route.current.properties = {{$route.current.properties}}</pre>
       ...
       <file name="book.html">
         controller: {{name}}<br />
         Book Id: {{properties.bookId}}<br />
       </file>

       <file name="chapter.html">
         controller: {{name}}<br />
         Book Id: {{properties.bookId}}<br />
         Chapter Id: {{properties.chapterId}}
       </file>
 ...
 *
 * In case of parameter name collision, `path` properties take precedence over `search` properties.
 *
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *    - **properties** – `{Object.<string|Object>}` – Map of strings or objects which will be turned to
